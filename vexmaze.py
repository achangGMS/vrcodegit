...
def rotate_to_best_dir():
        ...
        while (1):
            ...
            if ((front_distance.get_distance(MM) > 100) and (northcount == numVisits)):
                return

            drivetrain.turn_to_heading(90, DEGREES)
            if ((front_distance.get_distance(MM) > 100) and (eastcount == numVisits)):
                return

            drivetrain.turn_to_heading(180, DEGREES)
            if ((front_distance.get_distance(MM) > 100) and (southcount == numVisits)):
                return

            drivetrain.turn_to_heading(270, DEGREES)
            if ((front_distance.get_distance(MM) > 100) and (westcount == numVisits)):
                return
